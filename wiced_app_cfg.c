...
#else
/* tx buffer block size is 1024, allocate 40 blocks and 760 bytes for header, 1024*40+760=41720 bytes */
#define AUDIO_TX_BUFFER_SIZE        41720
#endif
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    {
        .max_links                      = 2,                                                           /**< Maximum simultaneous audio/video links */
#if !defined(CYW20706A2)
...
#ifdef WICED_APP_HFP_AG_INCLUDED
    // SDP record for HFP AG ( total length of record: 51 )
...
const wiced_bt_audio_config_buffer_t wiced_bt_audio_buf_config = {
    ...
    ,.audio_tx_buffer_watermark_level =   85
#endif
};
