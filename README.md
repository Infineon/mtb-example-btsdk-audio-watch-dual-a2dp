...
## Overview
This app demonstrates Bluetooth&#174; DualA2DP source,and HFP Hands-free Unit.

Features demonstrated:

 - AIROC&#8482; DualA2DP Source APIs
...
- The Watch\_dual\_a2dp app can demonstrate how use to DualA2DP.
- DualA2DP can use I2S interrupt or SW timer to decide the timing to read PCM.
...
- Use the buttons in the ClientControl DualA2DP tab.
...
- To play music from a .mp3 file, select the Media type as File, browse and select a .mp3 file,
  ...
  sinc\_44100\_mono.mp3,sinc\_44100\_stereo.mp3,sinc\_48000\_mono.mp3 and sinc\_48000\_stereo.mp3 in MP3_sample folder
...
- Put two audio sink devices such as Bluetooth&#174; headphone/speaker in pairable mode.
- Click on the "Start" button from the "BR/EDR Discovery" combo box in ClientControl to find the audio sink device.
- Select a peer device in the BR/EDR Discovery combo box.
- Click the "Connect" button under the DualA2DP tab. (Now click the "Start/Stop Streaming" button. Music will start playing/Stop on the peer device.)
- Select another peer device in the BR/EDR Discovery combo box.
- Click the "Connect" button under the DualA2DP tab. ("Connect button" becomes void because connection reaches maximum.)
- Click the "Start/Stop Streaming" button. Music will start playing/Stop on both peer devices.

HFP Hands-free Unit:

- Targets CYW920721M2EVB-03, CYW920721M2EVK-01, and CYW920721M2EVK-02 support HFP Hands-free Unit by default.
